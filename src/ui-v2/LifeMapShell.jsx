        ...
        <div ref={frameRef} className={`lifemapV2Frame${dragging ? ' lifemapV2Dragging' : ''}`}>
          ...
          <div className="lifemapV2HudLayer">
            ...
            {morph.target === 'inbox' && morph.isActive ? (
              <div ref={morph.windowMountRef} className="lifemapV2WindowMount" style={windowRectStyle('inbox')}>
                <InboxWindow
                  state={morph.state}
            ...
            {morph.target === 'assistant' && morph.isActive ? (
              <div ref={morph.windowMountRef} className="lifemapV2WindowMount" style={windowRectStyle('assistant')}>
                <AssistantWindow
                  state={morph.state}
                  contentVisible={morph.contentVisible}
                  onClose={closeWindow}
